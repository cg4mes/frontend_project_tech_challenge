...
def step_impl(context, url):
    if url.startswith("/"):
        result_url = f"{context.current_url}{url}"
    else:
        result_url = url
    GeneralComponents.wait_until_url_is(context.browser, result_url)
    return assert_that(context.web_driver.current_url, equal_to(result_url))
